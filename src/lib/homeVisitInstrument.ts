...
export const homeVisitInstrument: HomeVisitQuestion[] = [
  ...
  // BAGIAN B - LATAR BELAKANG KELUARGA
  {
    ...
    type: 'Skala 1-4',
    options: [
      { label: 'Orangtua/Ibu/Wali bekerja di sektor formal dan bukan satu-satunya tulang punggung keluarga', score: 4 },
      { label: 'Orangtua/Ibu/Wali bekerja di sektor formal dan menjadi satu-satunya tulang punggung keluarga', score: 3 },
      { label: 'Orangtua/Ibu/Wali bekerja di sektor informal dan bukan satu-satunya tulang punggung keluarga', score: 2 },
      { label: 'Orangtua/Ibu/Wali bekerja di sektor informal dan menjadi satu-satunya tulang punggung keluarga', score: 1 },
    ],
  ...
  },
  {
    ...
    type: 'Skala 1-4',
    options: [
      { label: '> Rp4.000.000', score: 4 },
      { label: 'Rp3.000.001 - Rp4.000.000', score: 3 },
      { label: 'Rp1.500.001 - Rp3.000.000', score: 2 },
      { label: '≤ Rp1.500.000', score: 1 },
    ],
    keterangan: 'Jika skor di bawah 71 keterangannya tidak disarankan, jika skor di bawah 86 keterangan dipertimbangkan, jika skor diatas 86 keterangannya disarankan'
  },
  {
    ...
    type: 'Skala 1-4',
    options: [
      { label: 'Rumah pribadi yang sederhana dengan jumlah anggota keluarga ≤ 4', score: 4 },
      { label: 'Rumah pribadi yang sederhana dengan jumlah anggota keluarga ≥ 5', score: 3 },
      { label: 'Bukan rumah pribadi tanpa biaya sewa (tumpangan, asrama atau panti asuhan)', score: 2 },
      { label: 'Bukan rumah pribadi dengan biaya sewa (kontrakan)', score: 1 },
    ],
    keterangan: 'Jika skor di bawah 71 keterangannya tidak disarankan, jika skor di bawah 86 keterangan dipertimbangkan, jika skor diatas 86 keterangannya disarankan'
  },
  {
    ...
    type: 'Skala 1-4',
    options: [
      { label: 'Memiliki ≥ 4 peralatan elektronik; memiliki mobil pribadi', score: 4 },
      { label: 'Memiliki ≥ 4 peralatan elektronik; memiliki > 1 motor pribadi', score: 3 },
      { label: 'Memiliki ≥ 4 peralatan elektronik; hanya memiliki 1 motor pribadi', score: 2 },
      { label: 'Hanya memiliki ≤ 3 peralatan elektronik inti; tidak memiliki kendaraan pribadi', score: 1 },
    ],
    keterangan: 'Jika skor di bawah 71 keterangannya tidak disarankan, jika skor di bawah 86 keterangan dipertimbangkan, jika skor diatas 86 keterangannya disarankan'
  },
  {
